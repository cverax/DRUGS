...
<h4>Vendedores</h4>
    ...
    <div class="input-field right-align col s12 m4">
        ...
        <a href="../app/reports/dashboard/registro_vendedor.php" target="_blank" class="btn waves-effect amber tooltipped" data-tooltip="reporte de acciondes de los vendedores"><i class="material-icons">assignment</i></a>
