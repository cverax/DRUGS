...
Dashboard_Page::headerTemplate('Origen');
?>
<br>
<div class="container">
        ...
        <form method="post" id="save-form" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="input-field col s12 m6">
                    ...
                    <input id="origen" type="text" name="origen" pattern="[a-zA-ZñÑáÁéÉíÍóÓúÚ\s]{1,50}" class="validate" required/>
...
Dashboard_Page::footerTemplate('origen.js');
?>
