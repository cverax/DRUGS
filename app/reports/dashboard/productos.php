...
if ($dataCategorias = $categoria->readAll()) {
    ...
    $pdf->Cell(0, 10, utf8_decode('Categoría: nose'), 1, 1, 'C', 1);
    // Se establece la categoría para obtener sus productos, de lo contrario se imprime un mensaje de error.
        ...
        if ($dataProductos = $categoria->readProductosCategoria()) {
            ...
            foreach ($dataProductos as $rowProducto) {
                ...
                $pdf->Cell(35, 10, utf8_decode($rowProducto['codigoproducto']), 1, 0);
                $pdf->Cell(65, 10, $rowProducto['nombreproducto'], 1, 0);
                $pdf->Cell(35, 10, $rowProducto['categoria'], 1, 0);
                $pdf->Cell(21, 10, $rowProducto['lote'], 1, 0);
                $pdf->Cell(30, 10, $rowProducto['vencimiento'], 1, 1);
            }
        } else {
