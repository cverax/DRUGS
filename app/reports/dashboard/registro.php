...
$pdf->startReport('Lotes por fecha');
...
if ($dataCategorias = $categoria->readAll()) {
    ...
    foreach ($dataCategorias as $rowCategoria) {
        ...
        if ($categoria->setId($rowCategoria['categoria'])) {
            ...
            if ($dataProductos = $categoria->readProductosCategoria()) {
                ...
                $pdf->Cell(46, 10, utf8_decode('categoria'), 1, 1, 'C', 1);
                ...
                foreach ($dataProductos as $rowProducto) {
                    ...
                    $pdf->Cell(46, 10, $rowProducto['categoria'], 1, 1);
                }
            } else {
